  ...
  constructor(props) {
    ...
    this.state = {
      ...
      dataTask: [
        {
          userName: 'Alex David',
          taskTitle: 'I need wedding photographer',
          budget: '11000',
          taskStatus: 'Assigned',
          offers: '3',
          questions: '3',
          ...
          userPic: require('../assets/user2.png'),
          taskDetail: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. ',
        ...
        <Content style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {dataTask && dataTask.map((item, i) => (
            <View key={i} style={{ paddingTop: 20 }}>
              <SegmentedControlTab
                values={['Description', `Task Assigned`, `Questions (${item.questions})`]}
          ...
          <View key={i} style={styles.bottomNav}>
            <Row>
              ...
              <Col xs={7}>
                ...
                >
                  <Text style={{ fontWeight: 'bold' }}>Assigned</Text>
                </Button>
              </Col>
            </Row>
