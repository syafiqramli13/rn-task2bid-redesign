  ...
  constructor(props) {
    ...
    this.state = {
      ...
      dataTask: [
        {
          userName: 'Andrew Lim',
          taskTitle: 'Cleaning my house and garage while babysit my child. Cleaning my house and garage while babysit my child',
          budget: '1000',
          taskStatus: 'Open',
          offers: '3',
          questions: '3',
          ...
          requesterReply: 'Please drop me a chat so that we can discuss more. Tq',
        ...
        <Content style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {dataTask && dataTask.map((item, i) => (
            <View key={i} style={{ paddingTop: 20 }}>
              <SegmentedControlTab
                values={['Description', `Offers (${item.offers})`, `Questions (${item.questions})`]}
                ...
                <View style={{ marginBottom: 70 }}>
                  <Card style={styles.cardContainer}>
                      ...
                      <Row>
                        ...
                        <Col xs={1}>
                          <TouchableHighlight
                            activeOpacity={1}
                            underlayColor="#f2f2f2"
                            onPress={this.goToLetsDuit}
                            style={{ height: 20, width: 30 }}
                          >
                            <Icon name="pencil-plus" type='MaterialCommunityIcons' style={{
                              color: '#ff3232',
                              fontSize: 20,
                              alignSelf: 'center',
                              width: 30
                    ...
                    <View style={{ marginHorizontal: 10 }}>
                      ...
                      {/* Doer offer with no requester reply */}
                      <Card style={styles.cardReplyContainer}>
                        <CardItem style={styles.cardContent}>
                          <Row>
                            <Col xs={1}>
                      ...
                      <View style={{ paddingVertical: 10 }}>
                        <Text note style={{ textAlign: 'center', color: '#ff3232' }}>
                          Opss! There is no offers for this task yet!
                        </Text>
                        <TouchableHighlight
                          style={{ width: 100, alignSelf: 'center', paddingVertical: 5 }}
                          activeOpacity={1}
                          underlayColor="#f2f2f2"
                          onPress={this.goToLetsDuit}
                        >
                ...
                <View style={{ marginBottom: 70 }}>
                  <Card style={styles.cardContainer}>
                      ...
                      <Row>
                        ...
                        <Col xs={1}>
                          <TouchableHighlight
                            activeOpacity={1}
                            underlayColor="#f2f2f2"
                            onPress={() => { this.toggleQuestionModal(true) }}
                            style={{ height: 20, width: 30 }}
                          >
                            <Icon name="pencil-plus" type='MaterialCommunityIcons' style={{
                              color: '#ff3232',
                    ...
                    <View style={{ marginHorizontal: 10 }}>
                      ...
                      {/* Doer Question with attachment & requester reply */}
                      <Card style={styles.cardReplyContainer}>
                        <CardItem style={styles.cardContent}>
                          <Row>
                            <Col xs={1}>
                      ...
                      <View style={{ paddingVertical: 10 }}>
                        <Text note style={{ textAlign: 'center', color: '#ff3232' }}>
                          Opss! There is no questions for this task yet!
                        </Text>
                        <TouchableHighlight
                          style={{ width: 100, alignSelf: 'center', paddingVertical: 5 }}
                          activeOpacity={1}
            ...
            <Row>
              ...
              <Col xs={7}>
                ...
                <Button block style={{
                  ...
                  onPress={this.goToLetsDuit}
                >
                  <Text style={{ fontWeight: 'bold' }}>Lets duit</Text>
                </Button>
              </Col>
            </Row>
...
const styles = StyleSheet.create({
  ...
  bottomNav: {
    ...
    borderTopColor: '#00cd00',
    borderRightColor: '#00cd00',
    borderLeftColor: '#00cd00',
    borderTopWidth: 1,
    borderLeftWidth: 0.1,
